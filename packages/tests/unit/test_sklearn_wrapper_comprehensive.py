...
class TestSklearnMulticlassSupport:
    ...
    def test_logistic_regression_multiclass_ova(self):
        ...
        base_model = LogisticRegression(random_state=42, multi_class="ovr")
        base_model.fit(X, y)
    ...
    def test_logistic_regression_multiclass_multinomial(self):
        ...
        base_model = LogisticRegression(random_state=42, multi_class="multinomial", solver="lbfgs")
        base_model.fit(X, y)
...
class TestSklearnWrapperAdvancedFeatures:
    ...
    def test_wrapper_with_different_solvers(self):
        ...
        for solver in solvers:
            ...
            try:
                base_model = LogisticRegression(random_state=42, solver=solver, max_iter=1000)
                base_model.fit(X, y)
